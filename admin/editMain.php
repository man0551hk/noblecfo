...
<div class="block">			
	...
	<form action = 'addTab.php' method = 'POST'>
		<input type = 'hidden' name = 'redirect' value = 'editMain.php'/>
	...
	<?php
		...
		while($row = mysql_fetch_array($result))
		{
			...
			print "<input type = 'hidden' name = 'redirect' value = 'editMain.php'/>";			
			...
			print "<a href = 'deleteTab.php?id=".$row["id"]."&textEditorID=".$row["textEditorID"]."&redirect=editMain'>刪除</a>";
			print "</td>";
			print "</form>";
			print "</tr>";
		}
...
<?php
	...
	$sql = "select textID, textindex, textarea from textEditor where textindex like 'atext%' order by textID ASC";
	$result = mysql_query($sql);
...
?>
		...
		<form action = 'insertImage.php' enctype="multipart/form-data" method = 'POST'>
			<input type = 'hidden' name = 'redirect' value = 'editMain'>
		...
		<?php
			...
			while($row2 = mysql_fetch_array($result2))
			{
				...
				print "</td>";
				print "<td>";
				print "<a href = 'deleteImage.php?id=".$row2["id"]."&redirect=editMain'>刪除</a>";
				print "</td>";
				print "</tr>";
			}
		?>
