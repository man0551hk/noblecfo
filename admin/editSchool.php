...
<div class="block">			
	...
	<form action = 'addTab.php' method = 'POST'>
		<input type = 'hidden' name = 'redirect' value = 'editSchool.php'/>
	...
	<?php
		...
		while($row = mysql_fetch_array($result))
		{
			...
			print "<input type = 'hidden' name = 'redirect' value = 'editSchool.php'/>";
			...
			print "<a href = 'deleteTab.php?id=".$row["id"]."'>刪除</a>";
			print "</td>";
			print "</form>";
			print "</tr>";
		}
...
<?php
	...
	$sql = "select textID, textindex, textarea from textEditor where textindex like 'dtext%' order by textID ASC";
	$result = mysql_query($sql);
...
?>
		...
		<form action = 'insertImage.php' enctype="multipart/form-data" method = 'POST'>
			<input type = 'hidden' name = 'redirect' value = 'editSchool'>
		...
		<?php
			...
			while($row2 = mysql_fetch_array($result2))
			{
				...
				print "</td>";
				print "<td>";
				print "<a href = 'deleteImage.php?id=".$row2["id"]."&redirect=editSchool'>刪除</a>";
				print "</td>";
				print "</tr>";
			}
		?>
