<?php require("interface1.php");?>
		<?php
			...
			{
				print "<font style = 'font-size:1.4em;'><b>".$row["courseName"]."</font>";
				print "<br/><br/>";
				...
				print "<th style = 'border:1px solid white;'>日期</th>";
				print "<th style = 'border:1px solid white;'>時間</th>";
				print "<th style = 'border:1px solid white;'>主題</th>";
				while($row2 = mysql_fetch_array($result2))
				{
					print "<tr>";
					print "<td style = 'border:1px solid white; padding-left:5px;' valign = 'middle' align = 'left'>".$row2["classNum"]."<br/>".$row2["classDate"]."</td>";
					print "<td style = 'border:1px solid white; padding-left:5px;'>".$row2["classTime"]."</td>";
					print "<td>";
						print "<table width = '100%' cellpadding = '0' cellspacing = '0'>";
